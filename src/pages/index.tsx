...
export default function Home() {
	...
	async function fetchTokenAccountsByOwner() {
		try {
			const response = await fetch('https://solana-mainnet.api.syndica.io/api-', {
				method: 'POST',
				headers: {
